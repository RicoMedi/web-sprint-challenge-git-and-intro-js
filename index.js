...
console.log('Task 6:', addArtist(artists, 'Ricardo Medina', '1995-2023', 'Full Stack Web Development','American','I am new to web development but I`m loving it'));
...
function artistByCountry(array,name){
  const onlyNational= [];
  for(let i=0; i< array.length; i++){
    if (array[i].nationality===name){
      onlyNational.push(array[i].name)
    }
